...
const SECTORS: Record<string, { name: string; tickers: string[]; description: string }> = {
  banking: {
    ...
    description: "Top banking stocks in India ranked by QuantAlpha 5-factor AI scoring. Quality, momentum, value, low-vol, and delivery analysis.",
  },
  it: {
    name: "IT & Technology",
    tickers: ["TCS.NS", "INFY.NS", "WIPRO.NS", "HCLTECH.NS", "TECHM.NS", "LTIM.NS", "PERSISTENT.NS", "COFORGE.NS", "MPHASIS.NS", "LTTS.NS"],
    description: "Best IT stocks in India by QuantAlpha AI scoring. 5-factor analysis including quality, momentum, and value.",
  },
  pharma: {
    ...
    description: "Top pharma stocks in India ranked by QuantAlpha 5-factor AI scoring.",
  },
  auto: {
    name: "Automobile",
    ...
    description: "Best auto stocks in India by QuantAlpha AI scoring.",
  },
  energy: {
    name: "Energy & Oil",
    tickers: ["RELIANCE.NS", "ONGC.NS", "NTPC.NS", "POWERGRID.NS", "COALINDIA.NS", "BPCL.NS", "IOC.NS", "HINDPETRO.NS", "GAIL.NS", "ADANIGREEN.NS"],
    description: "Top energy stocks in India ranked by QuantAlpha 5-factor AI scoring.",
  },
  fmcg: {
    name: "FMCG",
    ...
    description: "Best FMCG stocks in India by QuantAlpha AI scoring.",
  },
  metals: {
    name: "Metals & Mining",
    tickers: ["TATASTEEL.NS", "JSWSTEEL.NS", "HINDALCO.NS", "ADANIENT.NS", "SAIL.NS", "VEDL.NS", "NMDC.NS", "HINDCOPPER.NS", "MOIL.NS", "NATIONALUM.NS"],
    description: "Top metal stocks in India ranked by QuantAlpha 5-factor AI scoring.",
  },
  telecom: {
    name: "Telecom",
    tickers: ["BHARTIARTL.NS", "IDEA.NS", "TATACOMM.NS", "INDHOTEL.NS"],
    description: "Best telecom stocks in India by QuantAlpha AI scoring.",
  },
  infrastructure: {
    name: "Infrastructure",
    tickers: ["LT.NS", "ULTRACEMCO.NS", "ADANIPORTS.NS", "SHREECEM.NS", "ACC.NS", "AMBUJA.NS", "DLF.NS", "GODREJPROP.NS", "OBEROIRLTY.NS", "PRESTIGE.NS"],
    description: "Top infrastructure stocks in India ranked by QuantAlpha 5-factor AI scoring.",
  },
  "financial-services": {
    ...
    description: "Best financial services stocks in India by QuantAlpha AI scoring.",
  },
  cement: {
    name: "Cement",
    ...
    description: "Top cement stocks in India ranked by QuantAlpha 5-factor AI scoring.",
  },
  chemicals: {
    name: "Chemicals",
    ...
    description: "Best chemical stocks in India by QuantAlpha AI scoring.",
  },
  "consumer-durables": {
    ...
    description: "Top consumer durable stocks in India ranked by QuantAlpha 5-factor AI scoring.",
  },
  "real-estate": {
    name: "Real Estate",
    tickers: ["DLF.NS", "GODREJPROP.NS", "OBEROIRLTY.NS", "PRESTIGE.NS", "BRIGADE.NS", "SOBHA.NS", "PHOENIXLTD.NS", "NBCC.NS", "HIRANANDANI.NS"],
    description: "Best real estate stocks in India by QuantAlpha AI scoring.",
  },
  media: {
    name: "Media & Entertainment",
    tickers: ["ZEEL.NS", "SUNTV.NS", "PVR.NS", "INOXLEISUR.NS", "NETWORK18.NS", "DBL.NS"],
    description: "Top media stocks in India ranked by QuantAlpha 5-factor AI scoring.",
  },
};
...
export async function generateMetadata({
  ...
  return {
    title: `Best ${data.name} Stocks in India 2026 — QuantAlpha AI Analysis`,
    ...
    <div className="min-h-screen bg-surface text-on-surface">
      <div className="max-w-6xl mx-auto px-6 py-20">
          ...
          {data.tickers.map((ticker) => {
            ...
            return (
              <Link
                key={ticker}
                href={`/stocks/${ticker}`}
                className="ghost-border bg-surface-low/40 p-6 hover-glow transition-colors flex justify-between items-center"
              >
                <div>
        ...
        <div className="mt-16 text-center">
          ...
          <Link
            href="/signup"
            className="mt-4 inline-block px-6 py-3 bg-gradient-to-r from-[#c1c1ff] to-[#bdf4ff] text-[#0f0f1a] font-semibold text-sm"
          >
            Create free account
          </Link>
        </div>
