  ...
  return (
    <div className="rounded-xl bg-surface-high border border-outline/30 p-3 space-y-2">
      ...
      <div className="grid grid-cols-3 gap-2 text-center">
        {stock.price_unavailable ? (
          <div className="col-span-3 rounded bg-surface-container px-2 py-1">
            <div className="text-xs text-on-surface-variant italic">Price currently unavailable</div>
          </div>
        ) : (
          <>
            {stock.entry_price && (
