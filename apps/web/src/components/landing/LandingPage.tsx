...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-surface-deep text-text-primary selection:bg-primary-fixed selection:text-background">
      {/* Grid overlay */}
      ...
      {/* Top Nav Bar */}
      <header className="fixed top-0 w-full h-[80px] z-50 bg-panel-glass backdrop-blur-xl border-b border-border-glow">
        <div className="flex justify-between items-center h-full px-4 lg:px-16 max-w-[1400px] mx-auto">
          ...
          <button
            ...
            className="md:hidden flex items-center justify-center w-10 h-10 text-primary-fixed"
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/signup"
              className="bg-primary-fixed text-background font-mono text-[11px] font-bold tracking-[0.1em] uppercase px-5 py-2 hover:shadow-[0_0_20px_rgba(0,255,178,0.3)] transition-all duration-300"
            >
              Get Started
            </Link>
          </div>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-40 md:hidden">
          ...
          />
          <div className="absolute top-[80px] left-0 right-0 glass-strong border-b border-border-glow p-6 flex flex-col gap-2">
            <Link
              href="/dashboard"
              onClick={() => setMobileMenuOpen(false)}
            ...
            <div className="border-t border-border-glow pt-3 mt-2">
              <Link
                href="/pricing"
                onClick={() => setMobileMenuOpen(false)}
                className="text-text-muted hover:text-primary font-mono text-[11px] font-bold tracking-[0.2em] uppercase py-3 px-4 transition-colors block"
              >
                Pricing
              </Link>
            </div>
      ...
      <section className="relative pt-[200px] pb-20 md:pt-[220px] md:pb-32 overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-primary-fixed/5 rounded-full blur-[120px] pointer-events-none" />
        <div className="relative z-10 max-w-[1400px] mx-auto px-4 lg:px-16 flex flex-col items-center text-center">
          ...
          <h1 className="font-serif hero-title text-4xl sm:text-5xl md:text-8xl lg:text-[10rem] mb-6">
            ...
            <span className="block text-primary-fixed italic">Equity Research.</span>
            <span className="block text-tertiary-fixed-dim italic text-2xl sm:text-3xl md:text-6xl lg:text-7xl mt-4">
              Powered by Multi-Agent AI.
            </span>
          </h1>
          <p className="max-w-2xl text-lg md:text-xl text-text-muted leading-relaxed font-light mb-12">
            Deploy an army of{" "}
            <span className="text-text-primary font-semibold">
              specialised quantitative agents
            </span>{" "}
            that analyze, debate, and forecast market movements with unprecedented
            precision — across the{" "}
            <span className="text-text-primary">S&amp;P 500</span> and{" "}
            <span className="text-text-primary">NIFTY 500</span>.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 mt-10">
            <Link
              href="/signup"
              className="bg-primary-fixed text-background font-mono text-[12px] font-bold tracking-[0.1em] uppercase px-8 py-4 hover:shadow-[0_0_30px_rgba(0,255,178,0.4)] transition-all duration-300 text-center"
            >
              Start Free Trial
            </Link>
            <Link
              href="/dashboard"
              className="border border-outline-variant bg-surface/50 backdrop-blur-md text-text-primary font-mono text-[12px] font-bold tracking-[0.1em] uppercase px-8 py-4 hover:bg-surface-container hover:border-primary-fixed/50 transition-all duration-300 text-center"
            >
              View Dashboard
            </Link>
          </div>
          <div className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-tertiary-fixed/10 text-tertiary-fixed-dim font-mono text-[11px] font-bold tracking-[0.1em] uppercase">
            <span className="w-2 h-2 rounded-full bg-tertiary-fixed-dim animate-pulse" />
            Free during development phase
          </div>
          <div className="mt-6 flex flex-wrap justify-center gap-6 font-mono text-[11px] text-text-muted tracking-[0.1em] uppercase">
      ...
      <section className="max-w-[1400px] mx-auto px-4 lg:px-16 py-24 border-t border-border-glow">
        <div className="text-center mb-14">
          <span className="inline-flex items-center gap-2 px-3 py-1 bg-primary-fixed/10 text-primary-fixed font-mono text-[11px] font-bold tracking-[0.2em] uppercase mb-6">
          ...
          <p className="text-text-muted max-w-2xl mx-auto">
            Every AI agent now reasons over live technical indicators, insider
            flows, news sentiment, and sector peer comparisons — not placeholders.
          </p>
        </div>
      ...
      <section className="max-w-[1400px] mx-auto px-4 lg:px-16 py-24 border-t border-border-glow">
        <div className="text-center mb-12">
          <span className="inline-flex items-center gap-2 px-3 py-1 bg-tertiary-fixed/10 text-tertiary-fixed-dim font-mono text-[11px] font-bold tracking-[0.2em] uppercase mb-6">
            PARA-DEBATE&trade;
          </span>
          <h2 className="font-headline text-3xl md:text-5xl font-bold tracking-tight mb-4">
          ...
          <p className="text-text-muted max-w-2xl mx-auto">
            Before you invest, specialist agents argue every angle — macro,
            fundamentals, technicals, sentiment, geopolitics, and an adversarial
            devil&apos;s advocate — then a Bull vs. Bear debate settles it. A Head
            Analyst delivers the final verdict.
          </p>
        </div>
        <DebateShowcase />
        <div className="mt-10 text-center">
          <Link
            href="/dashboard"
            className="inline-block bg-primary-fixed text-background font-mono text-[12px] font-bold tracking-[0.1em] uppercase px-8 py-4 hover:shadow-[0_0_30px_rgba(0,255,178,0.4)] transition-all duration-300"
          >
            Watch them debate →
          </Link>
        </div>
      ...
      <section className="max-w-[1400px] mx-auto px-4 lg:px-16 py-24 border-t border-border-glow">
        <div className="text-center mb-12">
          <span className="inline-flex items-center gap-2 px-3 py-1 bg-secondary/10 text-secondary font-mono text-[11px] font-bold tracking-[0.2em] uppercase mb-6">
            Simple pricing
          </span>
          <h2 className="font-headline text-3xl md:text-5xl font-bold tracking-tight mb-4">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="relative glass border border-border-glow p-8 flex flex-col">
            ...
            <p className="mt-1 font-mono text-[11px] text-tertiary-fixed-dim font-bold tracking-[0.1em] uppercase">
              Currently free
            </p>
            <ul className="mt-8 space-y-3 font-mono text-[12px] text-text-muted flex-1">
              ...
              <li>Screener tools</li>
            </ul>
            <div className="mt-8">
              <Link
                href="/dashboard"
                className="block text-center border border-outline-variant font-mono text-[12px] font-bold tracking-[0.1em] uppercase px-6 py-4 text-text-muted hover:text-primary hover:border-primary-fixed/50 transition-all duration-200"
              >
                Get started free
              </Link>
            </div>
          ...
          {/* Investor Tier */}
          <div className="relative glass border-2 border-primary-fixed p-8 flex flex-col">
            <span className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 bg-primary-fixed text-background font-mono text-[10px] font-bold tracking-[0.2em] uppercase">
              Most popular
            </span>
            ...
            <div className="mt-8">
              <Link
                href="/dashboard"
                className="block text-center bg-primary-fixed text-background font-mono text-[12px] font-bold tracking-[0.1em] uppercase px-6 py-4 hover:shadow-[0_0_30px_rgba(0,255,178,0.4)] transition-all duration-300"
              >
                Upgrade to Investor
              </Link>
            </div>
      ...
      {/* CTA */}
      <section className="max-w-[1400px] mx-auto px-4 lg:px-16 py-24 border-t border-border-glow">
        <div className="glass border border-border-glow p-12 md:p-16 text-center">
      ...
      {/* Footer */}
      <footer className="bg-surface-container-lowest py-12 px-4 lg:px-16 border-t border-outline-variant/30">
...
function UpgradeCard({
  ...
  return (
    <div className="glass border border-border-glow p-6 hover:shadow-[0_0_20px_rgba(0,255,178,0.15)] hover:border-primary-fixed/40 transition-all duration-300">
...
function Stat({ num, label }: { num: string; label: string }) {
  return (
    <div>
      <div className="font-headline text-5xl md:text-6xl font-bold text-primary-fixed">
        {num}
      </div>
      <div className="mt-3 font-mono text-[11px] font-bold tracking-[0.2em] uppercase text-text-muted">
        {label}
      </div>
    </div>
  );
