...
def _build_analyst_context(ticker: str, market: str, engine) -> dict:
    ...
    if not matching.empty:
        ...
        context.update({
            ...
            "short_interest_pct": round(_r("short_interest_pct") * 100, 2) if _r("short_interest_pct") is not None else None,
    ...
    try:
        ...
        context = {
            ...
            **macro_in,
            ...
            "short_interest_pct": round(float(cached["short_interest_pct"]) * 100, 2) if cached.get("short_interest_pct") is not None else None,
